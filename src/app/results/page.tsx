...
const matches: UserMatches = {
  "test-user-1": {
    matches: {
      "match-key-1a": {
        recommendedVideo:
          "https://www.youtube.com/watch?v=a0ANLUYyRYI&ab_channel=Stanford",
      },
      "match-key-1b": {
        recommendedVideo:
          "https://www.youtube.com/watch?v=a0ANLUYyRYI&ab_channel=Stanford",
  ...
  "test-user-2": {
    matches: {
      "match-key-2a": {
        recommendedVideo:
          "https://www.youtube.com/watch?v=b5Ho2_Si6hY&ab_channel=GitHub",
      },
      "match-key-2b": {
        recommendedVideo:
          "https://www.youtube.com/watch?v=b5Ho2_Si6hY&ab_channel=GitHub",
    ...
    <div>
      ...
      {userToken in matches ? (
        <div className="flex flex-col gap-4">
          {Object.entries(matches[userToken].matches).map(
            ([matchKey, match]) => (
              <div
                key={matchKey}
                className="p-4 border-gray-400 border-2 rounded-lg flex gap-4"
              >
                <iframe
                  width="300"
                  height="169"
